         ...
         <el-col :xs="24" :sm="5" class="mb-5">
             ...
             <el-card class="box-card">
                 <div slot="header" class="clearfix">
                     ...
                     <el-button style="float: right; padding: 3px 0" icon="el-icon-remove-outline" type="text" @click="cardCollapse = !cardCollapse"></el-button>
                 </div>
                 <div v-if="cardCollapse" class="px-3">
                     <ul class="text-xs list-disc">
                         ...
                         <li>PM2.5 (Partículas menores a 2.5 micrómetros)</li>
                     </ul>
            ...
            <el-col :xs="24" :sm="15">
                <div class="border rounded mb-5">
                    <div class="w-auto bg-gray-400 p-2">
                        <h4 v-if="indicator_selected" class="text-lg"><b>Visualizando:</b> {{ indicator_selected }} </h4>
                    </div>
                    <div class="p-2">
                        <Trend
                                class=""
